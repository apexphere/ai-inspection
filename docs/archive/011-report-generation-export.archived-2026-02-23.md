> **⚠️ ARCHIVED:** This document was superseded on 2026-02-23.
> See `docs/design/011-report-generation-export.md` for the current version.
> Reason: A more comprehensive version (originally 013-report-generation-export.md) now serves as the canonical doc.
